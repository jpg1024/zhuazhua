...
const List<AnimalInfo> kAnimals = [
  AnimalInfo(id: 'tiger', name: '老虎', emoji: '🐯', personality: '威风凛凛', themeColor: Color(0xFFE8871E)),
  AnimalInfo(id: 'lion', name: '狮子', emoji: '🦁', personality: '霸气侧漏', themeColor: Color(0xFFC98A2B)),
  AnimalInfo(id: 'dog', name: '狗狗', emoji: '🐶', personality: '忠诚活泼', themeColor: Color(0xFFA9745B)),
  AnimalInfo(id: 'cat', name: '猫', emoji: '🐱', personality: '高冷傲娇', themeColor: Color(0xFF8E7CC3)),
  AnimalInfo(id: 'elephant', name: '大象', emoji: '🐘', personality: '稳重温柔', themeColor: Color(0xFF8DA3B9)),
  AnimalInfo(id: 'monkey', name: '猴子', emoji: '🐵', personality: '机灵调皮', themeColor: Color(0xFFB58A5F)),
  AnimalInfo(id: 'panda', name: '熊猫', emoji: '🐼', personality: '憨态可掬', themeColor: Color(0xFF6B8E5A)),
  AnimalInfo(id: 'kangaroo', name: '袋鼠', emoji: '🦘', personality: '活力四射', themeColor: Color(0xFFC77B4F)),
  AnimalInfo(id: 'giraffe', name: '长颈鹿', emoji: '🦒', personality: '优雅从容', themeColor: Color(0xFFE0B653)),
  AnimalInfo(id: 'seal', name: '海豹', emoji: '🦭', personality: '圆滚滚软乎乎', themeColor: Color(0xFF7FA8C9)),
  AnimalInfo(id: 'hippo', name: '河马', emoji: '🦛', personality: '慢悠悠', themeColor: Color(0xFF9B8AA6)),
